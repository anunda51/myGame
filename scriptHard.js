...
function updateQuestion() {
    ...
    num2.innerHTML = randomRange(30, 50);
    num3.innerHTML = randomRange(0, 50);
    total = parseInt(num1.innerHTML) + parseInt(num2.innerHTML) - parseInt(num3.innerHTML);;
    if (randomAns === 1) {
...
function checkAnswer() {
    ...
    var total = parseInt(num1.innerHTML) + parseInt(num2.innerHTML) - parseInt(num3.innerHTML);
    // checkpoint++;
